            ...
            <nav className="bg-white w-full z-50">
                <div className="container mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex flex-row items-center px-3 rounded-sm gap-1">
                            <div className="bg-orange-500 flex items-center justify-center rounded-md p-1">
                            ...
                            <h3 className="text-orange-500 font-anton text-xl pr-1">NWCPay</h3>
                        </div>
                ...
                <div className="container mx-auto px-6 py-12 md:py-14 relative z-10">
                    <div className="flex flex-col items-center gap-12">
                        ...
                        <div className="text-center">
                            <span className="inline-block bg-orange-100 text-orange-600 text-xs font-semibold px-3 py-1 rounded-md mb-4 tracking-wide">
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="flex flex-col items-center bg-zinc-900 backdrop-blur-sm p-6 sm:p-10 lg:p-12 rounded-2xl shadow-xl border border-gray-700/50 animate-fade-in">
                                <div className="flex flex-col sm:flex-row items-center gap-4 mb-6">
                                    <GiLightningShield
                                        className="text-orange-500 w-10 h-10 transform transition-transform duration-300 hover:scale-110"
                                        aria-hidden="true"
                                    />
                                    <h2
                                        id="security-title"
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6 text-center flex flex-col items-center">
                    <div className="flex items-center flex-col">
                        <img src={LogoLightningOrange} className="h-15" alt="NWCPay Logo" />
                    ...
                    <p className="text-xl text-zinc-700 font-medium mb-8 max-w-2xl mx-auto">
                        Connect your wallet and start accepting Bitcoin in seconds.
                    </p>
                    <button
                        onClick={() => navigate("/connect")}
